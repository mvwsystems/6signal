---
title: "We Ran 700 AI Visibility Checks in One Texas Market. Here's Who AI Actually Recommends."
slug: "we-ran-700-ai-visibility-checks-one-texas-market"
description: "700 automated checks of 12 real buyer prompts across ChatGPT, Gemini, Perplexity, Claude, and Google AI Overviews for one Texas plumbing company. The mention rates, the method, and the surface nobody is winning."
date: "2026-08-09"
category: "Field Note"
...
# We Ran 700 AI Visibility Checks in One Texas Market. Here's Who AI Actually Recommends.

Most claims about AI visibility are vibes.

Someone asks ChatGPT a question once, screenshots the answer, and writes a strategy post about it.

One check. One day. One phrasing.
...
Between July 7 and August 3, 2026, 6Signal's tracking system ran **700 automated checks** of 12 real buyer prompts across five AI engines and Google Maps, for one plumbing company in Red Oak, Texas — a Dallas–Fort Worth market.

The results, by engine:
...
Same company. Same market. Same buyer questions. Five completely different outcomes.

That spread is the story.

## The method — so you can judge the data

Disclosure first: the company is X-Act Plumbing, a 6Signal client. The numbers are published with the client's permission, and they come from our own tracking system — the same one that powers the [AI Visibility Audit](/visibility-check).

How the tracking works:

- **12 prompts, written the way buyers actually talk.** Not keywords. Questions like "Who is the best plumber in Red Oak, TX?", "I have a burst pipe in Red Oak, TX — which plumber can come out fast?", "Who should I call to replace a water heater in Red Oak, TX?", and "How much does a plumber cost in Red Oak, TX?" — plus brand-verification prompts like "What do reviews say about X-Act Plumbing?"
- **Six surfaces, checked daily.** ChatGPT, Gemini, Perplexity, Claude, Google AI Overviews, and Google Maps.
- **One binary question per check:** is the business named in the answer, or not?
- **700 checks over four weeks**, July 7 through August 3, 2026.

Repetition is the point. Any single AI answer varies by day, phrasing, and user. Patterns across hundreds of checks do not.

If you want to run this kind of testing yourself, the manual version is documented in [How to Test Whether AI Recommends Your Business](/research/how-to-test-whether-ai-recommends-your-business).
...
### Why ChatGPT and Perplexity land in the 70s

Both name the company in roughly seven of ten checks — strong, but less consistent than Gemini. Both engines assemble local answers from what the open web says: directories, review platforms, the company's own site, third-party mentions. That composite is strong for this company but not airtight, and the variance shows up as the missing 30%.
...
Because the zero is where the work is. We don't publish outcomes we can't verify, and we don't hide the surfaces we haven't won. A measurement system that only reports victories is a marketing system.

### What moved the numbers that are high?

The boring fundamentals, in the boring order: local entity cleanup first (Business Profile, reviews, citation consistency), machine-readable structure second, answer-ready content third. The full framework is in [The 6Signal Visibility Audit: What We Measure and Why](/research/the-6signal-visibility-audit-what-we-measure-and-why), and the measurement discipline in [How to Measure AI Visibility Without Lying to Yourself](/research/how-to-measure-ai-visibility-without-lying-to-yourself).
...
## Want your six scores?

Get the AI Visibility Audit. [The $27 audit](/visibility-check) runs your company through all six signals — instantly, for your trade and your market — and shows you where you're named, where you're skipped, and what to fix first.
