...
const FAQS = [
  {
    ...
    a: "No. Free tools return generic scores. This audit is generated by the same intelligence system 6Signal uses for retainer clients — specific to your business name, URL, trade, and city. The buyer journey, citation gaps, and competitive landscape are built for your market.",
  },
  {
    q: "Isn't this just an SEO audit?",
  ...
  {
    q: "I already pay an SEO company. Do I need this?",
    a: "Probably. Most SEO companies work on blue-link rankings — that's one layer of six. If they're not also handling AI recommendations, prompt visibility, voice, answer engines, and local entity cleanup, there are five layers they're not touching. The audit shows you exactly which gaps exist and how wide they are — including what to hand your SEO firm.",
  },
  {
    q: "How long does it take?",
    a: "Your audit generates in under 60 seconds after payment and appears immediately on screen. You can download a PDF and review it on your own time.",
  },
  {
  ...
  },
  {
    ...
    a: "Your results page gives you two options: a Strategy Brief for $97 that turns your gaps into an exact implementation plan, or a 1-Hour Strategy Call for $197 where we walk through your audit live and you leave with a clear execution decision.",
  },
  {
    q: "Is this a subscription?",
    a: "No. $27 one time. You get the audit. No recurring charges.",
  },
  {
    q: "What if something goes wrong?",
    a: "After payment you also receive an email with a permanent link to your audit, so you can reopen it on any device. If generation fails and we can't recover it, we regenerate it or refund the $27 — no back-and-forth, just email hello@6signal.co.",
  },
  {
    q: "Who is 6Signal?",
...
export default function VisibilityCheckPage() {
  ...
  return (
    <>
        ...
        <div className="wrap">
          <div className="vc2-form-head reveal">
            ...
            <p className="vc2-form-sub">
              Your audit is generated specifically for your business, your
      ...
      {/* ── SECTION 3B: THE SHIFT ────────────────────────── */}
      <section className="shift rule">
        <div className="wrap">
          <div className="vc2-section-head reveal">
            <span className="idx">Why this matters now</span>
            <h2 className="display vc2-section-headline">
          ...
          <div className="shift-flow">
            <div className="stage reveal">
              ...
              <p>
                You could rank seventh and still get calls. Being present somewhere
                on the page was enough to be considered.
              </p>
            </div>
