...
export const tradesBySlug: Record<string, TradeData> = {
  ...
  roofers: {
    ...
    ogDescription: "6 Signal helps roofing contractors own the AI shortlist in their market. AI Visibility Audit — $27.",
    ...
    auditNote: "For roofing contractors, we specifically prompt ChatGPT, Gemini, and Perplexity for roofers in your city and show you the exact output in your audit — instantly, no call required. You see what a homeowner sees when they ask AI to recommend a roofer after a storm.",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "No. One roofing company per local market. If your market is open, that position is available to take. If it's already taken, we'll tell you before you spend a dollar more.",
      },
    ],
  },
  ...
  plumbers: {
    ...
    auditNote: "For plumbing contractors, the audit tests emergency queries first — 'emergency plumber near me,' 'burst pipe repair open now' — because emergency is where the highest-value, fastest-converting leads come from. You see the exact AI output for your city in your audit.",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "No. One plumbing company per local market. If your market is open, you can take it. If not, we'll tell you before you spend a dollar more — and you still get the full visibility read.",
      },
    ],
  },
  ...
  hvac: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "No. One HVAC company per local market. If your market is open and you want the position, get the audit.",
      },
    ],
  },
  ...
  electricians: {
    ...
    auditNote: "For electrical contractors, we specifically test credential queries — 'licensed electrician near me,' 'insured electrician for panel work' — because license signals are what separate your company from unlicensed competition in AI results. You see the output in your audit.",
  ...
  "garage-doors": {
    ...
    auditNote: "For garage door companies, the audit specifically tests emergency and same-day queries — because that's where the majority of high-intent calls come from. We show you exactly what Siri, ChatGPT, and Maps return for those queries in your city — instantly, in your audit.",
  ...
  "tree-service": {
    ...
    auditNote: "For tree service companies, we specifically test certification and emergency queries — because homeowners hiring for hazardous work check credentials before they call. You see exactly what AI returns for those queries in your market, in your audit.",
